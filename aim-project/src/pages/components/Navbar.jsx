...
function Navbar() {
  return (
    <nav className="fixed top-0 left-0 w-full px-6 py-4 flex justify-between items-center bg-transparent z-20 relative">
      ...
      {/* Navbar Content */}
      <NavLink to="/" end className="text-white text-4xl font-bold tracking-wide relative z-20">
